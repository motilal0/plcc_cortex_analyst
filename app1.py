...
def df_to_excel(df: pd.DataFrame) -> bytes:
    ...
    # Reset the index to ensure all columns (including the index) are included in the Excel file
    df = df.reset_index()
...
def df_to_csv(df: pd.DataFrame) -> bytes:
    """Converts DataFrame to CSV bytes, ensuring all columns (including index) are included."""
    ...
    # Return CSV with all columns, including the reset index
